...
//    }
    ...
    public void menuDisplayCard() {
        ...
        for (int q = 0; q < cardListData.size(); q++) {
            ...
            try {
                ...
                load.setLocation(getClass().getResource("/userview/inventory/inventory.fxml"));
                AnchorPane pane = load.load();
                InventoryController cardC = load.getController();
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                JasperDesign jDesign = JRXmlLoader.load("E:\\Langguage Program\\Java\\PBO\\minimarket\\src\\userview\\inventory\\report.jrxml");
